...
echo 'valgrind ./pipex infile "/usr/bin/cat" "/usr/bin/tr a-z A-Z" "/usr/bin/wc -w" outfile'
valgrind ./pipex infile "/usr/bin/cat" "/usr/bin/tr a-z A-Z" "/usr/bin/wc -w" outfile
echo -n "Output of outfile: "
cat outfile && rm outfile
read
clear
...
echo Test 24: More pipes
echo 'valgrind ./pipex infile "cat" "head -50" "tr a-z A-Z" "grep ACHAK" "grep LIBFT" "tr A-Z a-z" "tail -5" "wc -c" outfile'
valgrind ./pipex infile "cat" "head -50" "tr a-z A-Z" "grep ACHAK" "grep LIBFT" "tr A-Z a-z" "tail -5" "wc -c" outfile
echo -n "Output of outfile: "
cat outfile && rm outfile
read
clear
